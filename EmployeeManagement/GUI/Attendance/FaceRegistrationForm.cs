    ...
    public partial class FaceRegistrationForm : Form
    {
        ...
        private void BtnSelectImage_Click(object? sender, EventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    pictureBoxPreview.Image?.Dispose(); // Dispose old image
        ...
        private async void BtnCaptureFromCamera_Click(object? sender, EventArgs e)
        {
            try
            {
                ...
                {
                    capturedImage?.Dispose(); // Dispose old image
                    ...
                    if (capturedImage != null)
                    {
                        ...
                        // Lưu ảnh chụp vào file tạm
                        selectedImagePath = Path.Combine(Path.GetTempPath(), $"captured_face_{DateTime.Now.Ticks}.jpg");
        ...
        private async void BtnRegister_Click(object? sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // Sử dụng EmployeeCode thay vì EmployeeID
                string employeeCode = txtEmployeeCode.Text;
                string employeeName = txtEmployeeName.Text;

                var result = await FaceRecognitionService.RegisterFaceAsync(employeeCode, employeeName, selectedImagePath);
                ...
                if (result.Success)
                {
                    ...
                    {
                        int employeeId = (int)cmbEmployees.SelectedValue;
                        // Sử dụng method có sẵn từ AttendanceBLL
